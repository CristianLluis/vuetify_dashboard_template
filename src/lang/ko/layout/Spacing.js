export default {
  ...
  howText:
    "요소에 _0~5_ 의 **margin** 이나 **padding**을 적용합니다. 각 크기의 증가는 일반적인 메테리얼 디자인 간격에 맞추어 디자인 되었습니다. 이 클래스들은 `{속성}{방향}-{크기}` 형식으로 적용됩니다.",
  propertyText: "_속성_ 은 다음과 같은 간격의 유형에 적용됩니다",
  properties: ["`m` - `margin`에 적용", "`p` - `padding`에 적용"],
  ...
  horizontalText:
    "`.mx-auto` 클래스로 너비가 정해진 블럭 요소를 가로 중앙 정렬 할 수 있습니다.."
};
