  ...
  examples: [
    {
      continuous: {
        ...
        desc:
          "연속적(Continuous) 슬라이더는 정확도가 문제가 되지 않을 때만 사용해야 합니다."
      },
      discrete: {
        header: "불연속 (Discrete)",
        desc:
      ...
      icons: {
        header: "아이콘 (Icons)",
        desc:
          "`append-icon`과 `prepend-icon` prop을 이용하여 슬라이더에 아이콘을 추가할 수 있습니다."
      },
      ...
      customColors: {
        ...
        desc:
          "`color`, `track-color`와 `thumb-color` prop들을 이용해 슬라이더의 색상을 정의할 수 있습니다."
      }
    }
  ],
  props: {
