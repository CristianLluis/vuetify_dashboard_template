  ...
  examples: [
    {
      ...
      absoluteWithoutActivator: {
        ...
        desc:
          "또한 `absolute` 와 `position-x`, `position-y` prop들을 함께 사용하면 활성자(activator) 없이도 메뉴를 원하는 절대좌표에 나타낼 수 있습니다. 이미지의 아무곳에나 오른쪽 클릭을 해보세요.",
        uninverted: true
      },
      hover: {
        header: "호버링 (Hover)",
      ...
      customTransition: {
        ...
        desc:
          'Vuetify엔 3개의 기본 트랜지션 **scale**, **slide**, **slide-x**, **slide-y** 가 있습니다. 하지만 트랜지션 인자로 직접 만든 트랜지션을 사용할 수도 있ㅅ브니다. 예를 들어 어떻게 스톡(stock) 트랜지션이 작동하는지 보려면  <a href="https://github.com/vuetifyjs/vuetify/blob/master/src/util/helpers.js#L13" target="_blank" rel="noopener">here</a>를 방문하세요.',
        uninverted: true
      },
      popover: {
