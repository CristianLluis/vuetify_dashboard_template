  ...
  examples: [
    {
      ...
      fixedTabs: {
        ...
        desc:
          "**fixed-tabs** prop 은 더 높은 최소 너비를 설정하고 새로운 최대 너비를 `v-tabs-item`에 적용합니다. 데스크탑 스크린에서, 탭 아이템은 `v-tabs` 컴포넌트위 중앙에 표시되고, 모바일에선 균등하게 채워집니다."
      },
      right: {
      ...
      alignWithTitle: {
        ...
        desc:
          "`v-tabs`을 `v-toolbar-title` 컴포넌트와 함께 나열합니다. (`v-toolbar-side-icon`나 `v-btn` 컴포넌트가 `v-toolbar` 안에 사용되어야만 합니다. May not work if the tab text is wrapped."
      },
      grow: {
        header: "Grow",
        desc:
      ...
      icons: {
        ...
        desc:
          "**prev-icon**과 **next-icon**를 사용하여 커스텀 페이지네이션 아이콘을 적용할 수 있습니다."
      }
    }
  ],
  props: {
