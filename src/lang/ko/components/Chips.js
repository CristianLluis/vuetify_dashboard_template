  ...
  examples: [
    {
      default: {
        header: "기본 (Default)",
        desc:
          "칩에는 다음 4가지 주 변형이 있습니다; 표준(regular), 아이콘 사용, 사진(portrait) 사용, 닫기 가능(closeable)",
        uninverted: true
      },
      colored: {
        header: "색상 (Colored)",
      ...
      closable: {
        ...
        desc:
          "닫기가 가능한 칩(Closable chips)은 `v-model`로 제어합니다. 칩이 닫혀있는지 알려면 `input` 이벤트를 Listen 하면 됩니다.",
        uninverted: true
      },
      inSelects: {
