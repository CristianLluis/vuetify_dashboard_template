  ...
  examples: [
    {
      permanent: {
        header: "기본값 (Default)",
        desc:
          "탐색 서랍은 어플리케이션의 여러 페이지들에 대한 링크를 모아 놓는데 사용합니다."
      },
      permanentClipped: {
        header: "색깔이 있는 서랍 (Colored drawer)",
        desc:
          "탐색 서랍은 어떤 어플리케이션 디자인에도 적합하게 커스터마이즈 될 수 있습니다. 어떤 컴포넌트든 서랍 안에 사용할 수 있는데 주로 사용하게 되는 컴포넌트는 `v-list` 와 모든 **list** 의 자식 컴포넌트, 그리고 `v-divder`일 겁니다."
      },
      permanentFloating: {
