export default {
  header: "Quick start",
  headerText:
    "Use one of the Vuetify Vue CLI packages _(based on the official examples)_ to get your project started in no time. Vuetify supports **SSR** (server-side rendering), **SPA** (single page application), **PWA** (progressive web application) and standard **HTML** pages.",
  alert1:
  ...
  newStoreAlert:
    'The new Vuetify store is now **live**!. Help support the project and get some cool swag at the same time! <a href="https://next.vuetifyjs.com/store" class="btn btn--white primary--text"><span class="btn__content">Check it out</span></a>',
  ...
  cdnText:
    "To test using Vuetify.js without installing a template from Vue CLI, copy the code below into your `index.html`. This will pull the latest version of Vue and Vuetify, allowing you to start playing with components. You can also use the [Vuetify starter](https://template.vuetifyjs.com) on codepen.",
  newHeader: "New applications",
  newText:
    "Vuetify has 8 pre-made Vue CLI templates, 3 which are forked from [official Vue.js templates](https://github.com/vuejs-templates). They contain small modifications to help you get started with Vuetify even faster. These packages require `vue-cli`. For more information on vue-cli, visit the official [Github](https://github.com/vuejs/vue-cli) repository. These templates are designed to get you started as fast as possible with your next project",
