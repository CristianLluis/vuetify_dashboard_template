export default {
  header: "Motion",
  headerText:
    "Smooth animations help make a UI feel great. Using Vue's transition system and re-usable functional components, you can easily control the motion of your application. Most components can have their transition altered through the <code>transition</code> prop.",
  components: [
    "v-fade-transition",
  ...
  examples: [
    {
      ...
      slideYTransitions: {
        ...
        desc:
          "Animations use the applications <code>$primary-transition</code>."
      },
      scaleTransition: {
  ...
  createYourOwnText2:
    "The <code>createSimpleTransition</code> function accepts 1 argument, name. This will be the name that you can hook into with your style. This is an example of what <code>v-fade-transition</code> looks like:",
  toc: [
    {
      text: "Motion",
      href: "introduction"
