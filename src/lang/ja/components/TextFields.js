export default {
  ...
  examples: [
    {
      ...
      prefixesAndSuffixes: {
        ...
        desc:
          "The **prefix** and **suffix** property allows you to prepend and append inline non-modifiable text next to the text-field"
      },
      customValidation: {
  ...
  props: {
    autoGrow:
      "Auto-grows the input. This option requires the use of **v-model**",
