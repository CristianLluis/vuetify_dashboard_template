export default {
  header: "Progress",
  headerText:
    "The `v-progress-circular` and `v-progress-linear` components are used to convey data visually to users. They can also represent an indeterminate amount, such as loading or processing. These components contain a slot that is centered within the component container.",
  ...
  examples: [
    {
      circularDefault: {
        header: "Default",
        desc:
          "By default, progress circular uses the application's secondary color."
      },
      circularColored: {
        header: "Colored",
      ...
      linearCustomHeightAndContextualColors: {
        ...
        desc:
          "A custom height or contextual color can be applied to a progress bar. The bar's primary color is your application's primary color."
      },
      linearCustomColors: {
