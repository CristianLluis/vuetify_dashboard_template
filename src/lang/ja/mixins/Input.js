export default {
  props: {
    ...
    prependIcon:
      "Prepend an icon to the component, uses same syntax as `v-icon`",
    prependIconCb: "Callback for prepended icon when clicked",
    readonly: "Puts input in readonly state",
    required:
      "Designates the input as required. Adds an asertisk to end of label. Does not perform any validation.",
