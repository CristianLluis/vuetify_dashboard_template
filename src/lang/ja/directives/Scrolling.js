  ...
  examples: [
    {
      default: {
        header: "Default",
        desc:
          "The default behavior is to bind to the window. If no additional configuration options are needed, you can simple pass your callback function.",
        uninverted: true
      },
      options: {
  ...
  params: [
    {
      "v-scroll": [
        ...
        },
        {
          ...
          desc:
            "The options to be passed to the event listener of the binding target"
        }
      ]
    }
  ]
