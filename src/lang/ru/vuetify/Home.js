export default {
  announcementBanner:
    "Это захватывающее объявление! Или, может быть, это реклама!",
  heading1: "Vuetify",
  ...
  features: [
    {
      ...
      text:
        "Vuetify готов из коробки к работе с 8 готовыми шаблонами vue-cli. От простого html до полномасштабного SSR. Вы стартуете свой проект за считанные минуты."
    },
    {
      img: "/static/doc-images/feature2.svg",
      title: "Семантика Material Components",
      text:
        "Будьте готовы заполучить огромное количество специализированных компонентов в свое распоряжение. С более чем 80 компонентами, у вас будет решение для любого приложения."
    },
    {
      img: "/static/doc-images/feature3.svg",
      title: "Хорошее сообщество",
      text:
        "Когда вы сталкиваетесь с проблемой, вам нужна помощь сразу. Vuetify предлагает поддержку чата в нашем огромном сообществе Discord."
    }
  ],
