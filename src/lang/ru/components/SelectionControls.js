export default {
  ...
  headerText:
    "Элементы управления выбора, позволяют пользователю выбирать параметры. Эти компоненты **должны** использоваться с помощью `v-model`, поскольку они не поддерживают свое собственное состояние.",
  ...
  examples: [
    {
      ...
      checkboxesColors: {
        ...
        desc:
          "Checkboxes могут быть окрашены с использованием любого из встроенных цветов и контекстных имен с помощью свойства `color`."
      },
      ...
      radiosDefault: {
        ...
        desc:
          "Radio-группы по умолчанию обязательны. Это можно изменить с помощью свойства `mandatory`."
      },
      radiosDirection: {
        header: "Radios - управление",
        desc:
          "Radio-группы могут быть представлены либо в виде строки, либо в столбце, используя их соответствующие свойства. По умолчанию используется столбец."
      },
      radiosColors: {
        header: "Radios - цвета",
        desc:
          "Radio могут быть окрашены с использованием любого из встроенных цветов и контекстных имен, с помощью свойства `color`"
      },
      switchesBoolean: {
      ...
      switchesColors: {
        ...
        desc:
          "Switches можно покрасить, используя любой из встроенных цветов и контекстных имен, используя свойство `color`."
      }
    }
  ],
  props: {
