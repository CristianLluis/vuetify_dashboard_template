  ...
  examples: [
    {
      dateLight: {
        header: "Выбор даты",
        desc:
          "Выбор даты существует в двух вариантах, портретная **(по умолчанию)** и альбомная. По умолчанию они вызывают событие `input` при выборе дня (для выбора даты) или месяца (для выбора месяца), но с **реактивным** свойством они могут обновить модель даже после клика года/месяца."
      },
      dateColorable: {
      ...
      dateWidth: {
        ...
        desc:
          "Вы можете указать допустимую ширину или сделать ее на всю ширину."
      },
      dateBirthday: {
      ...
      dateReadonly: {
        ...
        desc:
          "Выбор новой даты может быть отключен путем добавления **readonly** prop."
      },
      dateCurrent: {
