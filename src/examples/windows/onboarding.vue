<template>
  <v-card color="black" dark flat tile>
      ...
      <v-window-item v-for="n in length" :key="`card-${n}`">
        <v-card color="transparent" height="200">
          <v-layout
            ...
            fill-height
            tag="div"
          >Transparent themed, for background-imaged slides. Background color black added for demonstration purposes.</v-layout>
        </v-card>
      </v-window-item>
    </v-window>
    ...
    <v-card-actions>
      ...
      <v-item-group v-model="onboarding" class="text-xs-center">
