  ...
  data() {
    return {
      ...
      page: {
        ...
        description: `The <code>v-data-table</code> component is used for displaying tabular data. Features include sorting, searching, pagination, inline-editing, header tooltips, and row selection.`
      },
      breadcrumbs: [
        {
          text: "Components",
