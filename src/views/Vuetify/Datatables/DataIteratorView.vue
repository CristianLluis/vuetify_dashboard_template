  ...
  data() {
    return {
      ...
      page: {
        ...
        description: `The <code>v-data-iterator</code> component is used for displaying data, and shares a majority of its functionality with the <code>v-data-table</code> component. Features include sorting, searching, pagination, and selection.`
      },
      breadcrumbs: [
        {
          text: "Components",
