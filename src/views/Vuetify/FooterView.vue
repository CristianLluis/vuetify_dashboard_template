  ...
  data() {
    return {
      ...
      page: {
        ...
        description: `The <code>v-footer</code> component is used for displaying general information that a user might want to access from any page within your site.`
      },
      breadcrumbs: [
        {
          text: "Components",
