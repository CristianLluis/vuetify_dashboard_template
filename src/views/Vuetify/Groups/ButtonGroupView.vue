    ...
    <v-container fluid grid-list-xl page>
      <v-layout row wrap>
        <v-flex xs12 sm8 md12>
          ...
          <markdown class="subheading justify" :source="page.description" v-if="page.description"/>
          <div class="my-5"></div>
        </v-flex>
      </v-layout>
...
export default {
  ...
  data() {
    return {
      ...
      page: {
        title: this.$t("Components.ButtonGroups.header"),
        headline: "Introduction",
        description: this.$t("Components.ButtonGroups.headerText")
      },
      breadcrumbs: [
        {
          text: "Components",
        ...
        {
          text: this.$t("Components.ButtonGroups.header"),
          disabled: true
        }
      ]
    };
