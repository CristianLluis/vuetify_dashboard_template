  ...
  data() {
    return {
      ...
      page: {
        ...
        description: `The <code>v-time-picker</code>  is stand-alone component that can be utilized in many existing Vuetify components. It offers the user a visual representation for selecting the time.`
      },
      breadcrumbs: [
        {
          text: "Components",
