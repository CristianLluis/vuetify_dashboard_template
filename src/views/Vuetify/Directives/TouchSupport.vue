...
export default {
  ...
  data() {
    return {
      ...
      page: {
        title: this.$t("Directives.TouchSupport.header"),
        headline: "Introduction",
        description: this.$t("Directives.TouchSupport.headerText")
      },
      breadcrumbs: [
        {
          text: "Components",
        ...
        {
          text: "Vuetify Directives",
          disabled: false
        },
        {
          text: this.$t("Directives.TouchSupport.header"),
          disabled: true
        }
      ]
    };
