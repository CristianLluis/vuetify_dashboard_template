<template>
  <div>
    ...
    <v-container fluid grid-list-xl page>
      ...
      <section-header>Examples</section-header>
      <v-layout row wrap>
        <v-flex xs12>
          <section id="usage">
...
<script>
import VuetifyExampleMixin from "@/mixins/VuetifyExampleMixin";

export default {
  mixins: [VuetifyExampleMixin],
  data() {
    return {
      section: "components",
      component: "forms",
      page: {
        ...
        description: `When it comes to form validation, Vuetify has a multitude of integrations and baked in functionality. Want to use a 3rd party validation plugin? Out of the box you can use <a href="https://github.com/baianat/Vee-validate">Vee-validate</a> and <a href="https://github.com/monterail/vuelidate">vuelidate</a>.`
      },
      breadcrumbs: [
        {
          text: "Components",
