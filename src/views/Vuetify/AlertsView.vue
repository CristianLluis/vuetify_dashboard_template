  ...
  data() {
    return {
      ...
      page: {
        ...
        description: `The <code>v-alert</code> component is used to convey information to the user. Designed to stand out, the alerts come in four contextual styles, success, info, warning, and error.`
      },
      breadcrumbs: [
        {
          text: "Components",
