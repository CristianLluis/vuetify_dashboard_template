<template>
  <v-content>
    <v-parallax src="/static/doc-images/vbanner.jpg" height="150">
        ...
        <v-flex xs6>
          <v-layout row wrap>
            <v-flex xs12 no-wrap class="text-xs-center text-md-right">
              <v-tooltip bottom>
                <v-btn icon slot="activator" class="mx-0" @click.native="today">
                  <v-icon color="white">today</v-icon>
                </v-btn>
                <span>Today</span>
              </v-tooltip>
              <v-tooltip bottom>
                <v-btn icon slot="activator" class="mx-0" @click.native="changeView('basicDay')">
                  <v-icon color="white">view_day</v-icon>
                </v-btn>
                <span>Basic Day</span>
              </v-tooltip>
              <v-tooltip bottom>
                <v-btn icon slot="activator" class="mx-0" @click.native="changeView('basicWeek')">
                  <v-icon color="white">view_week</v-icon>
                </v-btn>
                <span>Week</span>
              </v-tooltip>
              <v-tooltip bottom>
                <v-btn icon slot="activator" class="ml-0" @click.native="changeView('month')">
    ...
    <v-container fluid grid-list-xl>
      <v-layout row wrap>
        <v-flex xs12>
          <v-card
            flat
            class="card--flex-toolbar app-calendar"
            :style="{ height: heightSet + 'px' }"
          >
              ...
              <v-flex xs12 sm6>
                ...
                >
                  ...
                  <v-date-picker
                    ...
                    @input="dialog.formattedStart = formatDate($event)"
                    no-title
                    scrollable
                    actions
                  >
              ...
              <v-flex xs12 sm6>
                ...
                >
                  ...
                  <v-date-picker
                    ...
                    @input="dialog.formattedEnd = formatDate($event)"
                    no-title
                    scrollable
                    actions
                  >
