        ...
        <v-card-text>
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-flex xs12>
                <v-text-field prepend-icon="c" label="Last name" v-model="form.last"></v-text-field>
              </v-flex>
              <v-flex xs12>
                <v-text-field prepend-icon="c" label="Nickname" v-model="form.nickname"></v-text-field>
              </v-flex>
              <v-flex xs12>
                <v-text-field
              ...
              <v-flex xs12>
                <v-text-field prepend-icon="work" label="Job" v-model="form.job"></v-text-field>
              </v-flex>
              <v-flex xs12>
                <v-menu
                  ref="datepicker"
              ...
              <v-flex xs12>
                <v-text-field prepend-icon="home" label="Address" v-model="form.address"></v-text-field>
              </v-flex>
            </v-layout>
          </v-container>
